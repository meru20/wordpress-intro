...
class bootstrap_5_wp_nav_menu_walker extends Walker_Nav_menu
{
  ...
  function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
  {
    ...
    $output .= apply_filters('walker_nav_menu_start_el', $item_output, $item, $depth, $args);
		...
		register_nav_menus(
			array(
				'menu-1' => __( 'Primary', 'alkali-friday' ),
...
function alkali_friday_scripts() {
	...
	wp_enqueue_style( 'alkali-friday-bootstrap-js',  get_template_directory_uri() . '/js/bootstrap.min.js', array(), '5.0.1',  true);

	//STANDARD UNDERSCORE SCRIPT ENQUEUE
